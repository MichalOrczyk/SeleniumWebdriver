...
def test_searchResults(test_browser):
    ...
    # Check if some information about Kraków exists and print it
    element = driver.find_element(By.XPATH, "//*[@id='mw-content-text']/div[1]/p[1]")
